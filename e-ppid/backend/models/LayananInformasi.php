...
class LayananInformasi extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['kd_jenis_permohonan', 'id_user', 'id_ekskalasi' , 'id_status', 'id_admin'], 'integer'],
            [['kebutuhan_informasi', 'tujuan_kebutuhan_informasi', 'jawaban', 'catatan_internal'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kd_jenis_permohonan' => 'Kd Jenis Permohonan',
            'id_user' => 'Id User',
