...
$this->title = 'PPID Dinas Kominfo Provinsi Jawa Timur';
$profil = Page::find()->where(['slug' => 'profil-ppid'])->one();

$berita = Post::find()->where(['category_id' => 4])->limit(4,1)->all();
$galery = Post::find()->where(['category_id' => 10])->all();
...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Selamat Datang di <br /><span>PPID Dinas Komunikasi dan Informatika</spa>
      </h1>
      <h2>Pemerintah Provinsi Jawa Timur</h2>
      <div class="d-flex">
        <a href="#about" class="btn-get-started scrollto">Beranda</a>
        <a href="<?= Yii::$app->settings->get('general.video', 'a') ?>" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Simak Video <i class="icofont-play-alt-2"></i></a>
      </div>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
        ...
        <?php foreach ($berita as $itemBerita) : ?>
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img"><?= $itemBerita->getThumbnail(['class'=>'img-fluid']) ?></div>
              <h4 class="title"><a href="/<?= $itemBerita->slug ?>"><?= $itemBerita->title ?></a></h4>
              <p class="description"><?= substr($itemBerita->shortContent,0,100)."..." ?><?= Html::a('Selengkapnya', [$itemBerita->slug], ['class' => 'read-more']) ?></p>
            </div>
          </div>
        <?php endforeach ?>
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <?= $this->render('/items/page.php', ['page' => $profil,'short'=>true]) ?>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <h3>Layanan <span>Informasi</span></h3>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="<?= \yii\helpers\url::to(['informasi-yang-wajib-disediakan-dan-diumumkan-secara-berkala']) ?>">Informasi Berkala</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="<?= \yii\helpers\url::to(['category/informasi-serta-merta']) ?>">Informasi Serta Merta</a></h4>
              <p>informasi yang disediakan berkaitan dengan hajat hidup orang banyak dan ketertiban umum, serta wajib diumumkan secara serta merta tanpa penundaan</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="<?= \yii\helpers\url::to(['informasi-setiap-saat']) ?>">Informasi Setiap Saat</a></h4>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <h3>Galeri <span>PPID</span></h3>
          <p>Galeri Foto kegiatan PPID Dinas Kominfo Provinsi Jawa Timur</p>
        </div>
        ...
        <?php foreach ($galery as $itemGalery) : ?>
            <?php
            $tag = "";
            foreach($itemGalery->getTags()->all() as $i){
                $tag .= $i->title." "; 
                $filterTag .= "filter-".$i->title." ";
            }
            ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <?= $itemGalery->getThumbnail(['class'=>'img-fluid']) ?>
            <div class="portfolio-info">
              <h4><?= $itemGalery->title ?></h4>
              <p><?= $tag ?></p>
              ...
              <a href="<?= \yii\helpers\url::to([$itemGalery->slug]) ?>" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        <?php endforeach; ?>
        <!--
    ...
    <!--section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Daftar pertanyaan yang sering disampaikan seputar permohonan informasi</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Untuk mempermudah masyarakat dalam mengaskses layanan informasi, PPID Dinas Kominfo Provinsi Jawa Timur menyediakan jalur komunikasi sebagai berikut:</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Alamat</h3>
              <p>Dinas Kominfo Provinsi Jawa Timur, Jl. Ahmad Yani No.242-244, Gayungan, Kec. Gayungan, Kota SBY, Jawa Timur 60235</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <h3>Email</h3>
              <p>ppid-kominfo_at_jatimprov.go.id</p>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6 ">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15828.6209766758!2d112.7288628!3d-7.3364564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x36745df55ae0b3d3!2sDinas%20Komunikasi%20dan%20Informatika%20Pemerintah%20Provinsi%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1603964998919!5m2!1sid!2sid" width="540" height="367" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </div>
